...
#[no_mangle]
pub unsafe extern "C" fn CINTdset0(mut n: i32, mut x: *mut libc::c_double) {
    let mut i: i32 = 0;
    i = 0 as i32;
    while i < n {
        *x.offset(i as isize) = 0 as libc::c_double;
        i += 1;
        i;
    }
}
...
pub unsafe extern "C" fn CINTdgemm_NN1(
    ...
    while j < n {
        i = 0 as i32;
        while i < m {
            *c.offset((i + ldc * j) as isize) = 0 as libc::c_double;
            i += 1;
            i;
        }
        kp = 0 as i32;
...
pub unsafe extern "C" fn CINTdgemm_NT(
    ...
    while j < n {
        i = 0 as i32;
        while i < m {
            *c.offset((i + m * j) as isize) = 0 as libc::c_double;
            i += 1;
            i;
        }
        kp = 0 as i32;
